...
int main ()
{
    ...
    equipo AMUKE
    21 abr 21
    Programa 3. Pide dos valores reales,  calcula  promedio y multiplica muestra resultadps
    */
printf ("/n/n Programa 3");
    ...
    printf ("/N El promedio es %f",multiplica);
    printf ("/N El promedio es %f",divide);
